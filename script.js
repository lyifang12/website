...
const i18n = {
  ...
  en: {
    ...
    aboutDesc: "Profile",
    aboutBody:
      "I am a first-year student in the Department of Popular Music at Taipei City University of Science and Technology, and currently a UX intern at a stealth startup. My journey started from music, then gradually expanded into photography and video editing. I have participated in school and external performances, MV production, and music festival photography. Right now, I am focused on building my portfolio and strengthening practical skills while developing my own visual style.",
    aboutPoint1: "First-year student in the Department of Popular Music, TCUST.",
    aboutPoint2: "Currently a UX intern at a stealth startup.",
    aboutPoint3: "Creative journey expanded from music to photography and editing.",
    aboutPoint4: "Actively building projects and practical experience.",
    eduTitle: "Education",
    eduPoint1: "Department of Music, Chung Hwa Arts School.",
    eduPoint2: "Department of Popular Music, TCUST (first year).",
    ...
    expTitle: "Experience",
    expPoint1: "Chung Hwa Arts School Spring/Fall Exhibition Orchestra.",
    expPoint2: "2023 Kaohsiung Wind Festival, Taiwan Youth Flute Ensemble.",
    expPoint3: "MV shooting and recording collaboration with Kun Shan University.",
    expPoint4: "Rise Music Festival Photography Team.",
